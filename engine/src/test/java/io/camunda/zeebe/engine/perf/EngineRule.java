...
public final class EngineRule extends ExternalResource {
  ...
  public static final int PARTITION_ID = Protocol.DEPLOYMENT_PARTITION;
  ...
  public static final class ReprocessingCompletedListener implements StreamProcessorLifecycleAware {
  ...
  public static class ProcessingExporterTransistor implements StreamProcessorLifecycleAware {
